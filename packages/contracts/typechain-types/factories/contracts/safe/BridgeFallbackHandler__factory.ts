...
import type {
  BridgeFallbackHandler,
  BridgeFallbackHandlerInterface,
} from "../../../contracts/safe/BridgeFallbackHandler";
...
export class BridgeFallbackHandler__factory {
  static readonly abi = _abi;
  static createInterface(): BridgeFallbackHandlerInterface {
    return new Interface(_abi) as BridgeFallbackHandlerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as BridgeFallbackHandler;
  }
}
