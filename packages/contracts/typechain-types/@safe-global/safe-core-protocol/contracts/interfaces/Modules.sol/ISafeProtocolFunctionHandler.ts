...
export interface ISafeProtocolFunctionHandlerInterface extends Interface {
  getFunction(
...
export interface ISafeProtocolFunctionHandler extends BaseContract {
  connect(runner?: ContractRunner | null): ISafeProtocolFunctionHandler;
  waitForDeployment(): Promise<this>;

  interface: ISafeProtocolFunctionHandlerInterface;
