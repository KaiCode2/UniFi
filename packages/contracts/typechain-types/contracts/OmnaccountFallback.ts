...
export interface OmnaccountFallbackInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ACROSS_BRIDGE"
...
export interface OmnaccountFallback extends BaseContract {
  connect(runner?: ContractRunner | null): OmnaccountFallback;
  waitForDeployment(): Promise<this>;

  interface: OmnaccountFallbackInterface;
