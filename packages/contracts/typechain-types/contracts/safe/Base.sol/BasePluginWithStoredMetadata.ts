...
export interface BasePluginWithStoredMetadataInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "metadataHash"
      | "metadataProvider"
...
export interface BasePluginWithStoredMetadata extends BaseContract {
  connect(runner?: ContractRunner | null): BasePluginWithStoredMetadata;
  waitForDeployment(): Promise<this>;

  interface: BasePluginWithStoredMetadataInterface;
  ...
  ): TypedContractMethod<[_metadataHash: BytesLike], [string], "view">;
  getFunction(
