...
export interface CCIPHookReceiverInterface extends Interface {
  getFunction(
...
export interface CCIPHookReceiver extends BaseContract {
  connect(runner?: ContractRunner | null): CCIPHookReceiver;
  waitForDeployment(): Promise<this>;

  interface: CCIPHookReceiverInterface;
