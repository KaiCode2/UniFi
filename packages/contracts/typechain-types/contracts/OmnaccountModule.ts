...
export interface OmnaccountModuleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "bridgeFallbacks"
      | "getFallback"
...
export interface OmnaccountModule extends BaseContract {
  connect(runner?: ContractRunner | null): OmnaccountModule;
  waitForDeployment(): Promise<this>;

  interface: OmnaccountModuleInterface;
